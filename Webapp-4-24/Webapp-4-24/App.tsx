  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg relative max-w-md w-full">
        <button
          onClick={onClose}
          className="absolute top-2 right-2 text-red-500 border border-red-500 rounded-full w-6 h-6 flex items-center justify-center"
        >
          X
        </button>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full"
              style={{
                background: `linear-gradient(to right, ${getMoodColor(1)} 0%, ${getMoodColor(10)} 100%)`,
              }}
            />
    ...
    return (
      <div className="bg-white p-6 rounded-lg relative max-w-md w-full">
        ...
        <div className="flex justify-between mb-4">
          <button onClick={() => setShowYearView(true)}>
...
const Overview: React.FC = () => {
  ...
  const avgMood = currentEntries.length
    ? currentEntries.reduce((sum, entry) => sum + entry.mood, 0) /
